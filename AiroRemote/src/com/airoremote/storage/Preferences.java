package com.airoremote.storage;
...
public class Preferences {
	...
	public static final String KEY_IS_TEST_AUTO_START = "AUTO_START";
	public static final String KEY_IS_REGISTERED_WITH_GCM = "IS_REGISTERED_WITH_GCM";
	...
	public void saveSignalStrength(SignalStrengh signalStrength) {
		putValue(KEY_SIGNAL_STRENGTH,
				String.valueOf(signalStrength.strsignal_strength));
	...
	//Code Added by Ankit for Auto Start from Server
	public void setisTestAutoStart(String status) {
		putValue(KEY_IS_TEST_AUTO_START, status);
	}

	public String getisTestAutoStart() {
		return getValue(KEY_IS_TEST_AUTO_START, "");
	}
	
	public void setisRegisteredwithGCM(boolean status) {
		putValue(KEY_IS_REGISTERED_WITH_GCM, status);
	}

	public boolean getisRegisteredwithGCM() {
		return getValue(KEY_IS_REGISTERED_WITH_GCM, false);
	}
