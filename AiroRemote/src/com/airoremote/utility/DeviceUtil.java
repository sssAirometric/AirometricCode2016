...
import com.airoremote.utility.runners.MOTestRunner;
import com.airoremote.utility.runners.Runner;
...
//New code added by ankit on 02/07/2016
					...
					tac = identity.getTac();
					pci = identity.getPci();
					//System.out.println("DeviceUtil tac:"+tac+" pci "+pci);
					/*if (Constants.OS_VERSION_NPREVIEW <= deviceOSVersion) {
						earfcn = ((CellInfoLte) info).getCellIdentity().getEarfcn();
					}*/
