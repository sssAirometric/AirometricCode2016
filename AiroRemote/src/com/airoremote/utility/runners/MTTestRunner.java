...
import com.airoremote.listeners.CallReceiver;
...
public class MTTestRunner extends Runner implements Serializable {
    ...
    private CallStateReceiver callStateRec;
	...
	public void startTest() {
		//System.out.println("r u der??333");
	...
	protected void stateChanged(int state, String incomingNumber) {
		...
		case TelephonyManager.CALL_STATE_RINGING:
			...
			Log.i("device os",deviceOSVersion+"");
			if(deviceOSVersion >= Constants.OS_VERSION_LOLLIPOP) {//>=
				answeringCall();	//working function changed by ankit 3/12/2015
				//callAnswer();
			} else {
				answerPhoneHeadsethook();
			}		
	...
	public void answerPhoneHeadsethook() {
		Log.i("@answerPhoneHeadsethook", "test check");
	...
	private void answeringCall() {
		Log.i("@answeringCall","for android os 5+");
		try {
			...
			*/
			 ...
			 /*
			  * this code is written by ankit on 24/02/16 specific for HTC device auto answering for 
			  * versions equals to lollipop and marshmallow. 
			  */
			 String manufacturer = android.os.Build.MANUFACTURER;
			 System.out.println("check manufacturer of device -"+manufacturer);
