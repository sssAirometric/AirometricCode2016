...
import com.airometric.TermsOfUsageActivity;
...
public class APIManager {
	...
	public static String API_SERVICE_URL = Constants.API_SERVER_URL + "Airometric/rest/file/";//+"ThinClient/rest/file/"
	...
	//command codes for demo
	public static final String CMD_DEMOACCEPT_TERMS = "demoupdateTerms";
	public static final String CMD_DEMOLOGIN = "demovalidate";
	public static final String CMD_DEMOUPLOAD = "demouploadTest";
	public static final String CMD_DEMODOWNLOAD = "demodownload";
	...
	public Status processAcceptTermsOfUsage(String userName) {
		...
		String strLoginUrl = API_SERVICE_URL + CMD_DEMOACCEPT_TERMS;
	...
	public Status processLogin(String sUserId, String sPassword, String sIMEI) {
		...
		String strLoginUrl = API_SERVICE_URL +  CMD_DEMOLOGIN;//CMD_LOGIN
		//Log.i("Login URL: ",strLoginUrl);
		try {
			HttpClient httpclient = new DefaultHttpClient();
			HttpPost httppost = new HttpPost(strLoginUrl);
			List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
			...
			httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
			//Log.i("status_code : ",sUserId+","+sPassword+","+sIMEI);
			HttpResponse responseObj = httpclient.execute(httppost);
			int status_code = responseObj.getStatusLine().getStatusCode();
			...
			//Log.i("RESPONSE:",status_code+"hie");
			log("$$$$$$$$$$$$$$$$$$$$");
			log(response);
			log("$$$$$$$$$$$$$$$$$$$$");
			if (Validator.isEmpty(response)) {
	...
	public Status processDownload(String sUsername, String sPassword,
		...
		String strDownloadUrl = API_SERVICE_URL + CMD_DEMODOWNLOAD + "?imei="
...
//				}
	...
	public Status processUpload(String sUsername, String sPassword,
		...
		String strUploadUrl = API_SERVICE_URL + CMD_DEMOUPLOAD;
		//log("Upload URL: " + strUploadUrl);
		logMsg += "\n" + "Upload URL: " + strUploadUrl;
		Log.i("upload file path and name", logMsg);
		try {
