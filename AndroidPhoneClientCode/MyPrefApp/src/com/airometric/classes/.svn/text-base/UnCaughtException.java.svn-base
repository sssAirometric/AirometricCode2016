...
public class UnCaughtException implements UncaughtExceptionHandler {
	private static final String RECIPIENT = Constants.CRASH_REPORT_EMAIL_ID;
	...
	public void uncaughtException(Thread t, Throwable e) {
		try {
			...
			report.append("Application Version : ")
					.append(context.getString(R.string.version)).append('\n')
					.append('\n');
