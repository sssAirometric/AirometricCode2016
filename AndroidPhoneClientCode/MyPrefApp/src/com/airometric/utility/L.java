...
public class L {
	...
	//Created by Ankit to get the call drop time
	public static String log_mo1(String path, String msg) {
		Log.d(StringUtils.MO_LOG_TAG, msg);
		return FileUtil.writeToLogcatFile(path, msg, StringUtils.MO_LOG_TAG);
	}
