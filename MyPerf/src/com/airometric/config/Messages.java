...
public class Messages {
	...
	public static final String CONFIG_FILE_DATA_NOT_AVAIL = "Please contact to Airometric to set config for any test.";
	public static final String EnableGps = "Please enable your GPS and come back.";
